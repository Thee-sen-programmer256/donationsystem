...
<body>
  ...
  <div class="container">
    <div class="title" style="">Patient_Registration</div>
    <div class="content">
      <form action="#">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your number" name="conatct"required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <select class="" name="" style="height: 62%;
            width: 100%;  max-height: 300px;border-radius:5px;border: 1px solid #ccc;">
            <option style="color:gray;">--select--</option>
    ...
    <option value="zimbabwean">Zimbabwean</option>
          ...
          <div class="input-box">
            ...
            <input type="file" placeholder="Confirm your password" name="image" required>
          </div>
          <div class="input-box">
