...
<body>
     <?php
       $find_notifications = "Select * from notify where statuss = 'Active'";
       ...
       $deactive_notifications_dump = array();
        while($rows = mysqli_fetch_assoc($result)){
                ...
                $notifications_data[] = array(
                            "notifyId" => $rows['notifyId'],
                            "notifications"=>$rows['notifications'],
                            // "message"=>$rows['message']
                );
        }
        //only five specific posts
        $deactive_notifications = "Select * from notify where statuss = 'Inactive' ORDER BY notifyId DESC LIMIT 0,5";
                      ...
                      <div id="list">
                       <?php
                          foreach($notifications_data as $list_rows){?>
                            <li id="message_items">
                            <div class="message alert alert-warning" data-id=<?php echo $list_rows['notifyId'];?>>
                              <span><?php echo $list_rows['notifications'];?></span>
                              <div class="msg">
                                <p><?php 
                                  echo $list_rows['notifications'];
                                ?></p>
                              </div>
                            </div>
                            </li>
                     ...
                     <?php }else{?>
                        ...
                        <?php
                          foreach($deactive_notifications_dump as $list_rows){?>
                            <li id="message_items">
                            <div class="message alert alert-danger" data-id=<?php echo $list_rows['notifyId'];?>>
                              <span><?php echo $list_rows['notifications'];?></span>
                              <div class="msg">
                                <p><?php 
                                  echo $list_rows['notifications'];
