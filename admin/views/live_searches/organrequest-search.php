...
if(isset($_GET['input'])){
    ...
    $query = "SELECT * FROM request WHERE full_name LIKE '$input%' Or age LIKE '$input%' Or status LIKE '$input%' Or organ LIKE '$input%' Or blood_group LIKE '$input%' Or date_request LIKE '$input%'";
